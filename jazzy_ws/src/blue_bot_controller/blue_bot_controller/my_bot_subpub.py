...
class mybotsubpubNode(Node):
    def __init__(self) -> None:
        super().__init__("blue_bot_subpub")
    ...
    def image_callback(self, msg: CompressedImage):
        ...
        if picnanosec < 100000000:
            ...
            cv.imwrite(f'/ROS2_blue_bot/blue_bot/src/blue_bot_controller/resource/24_10_19_sensorDump/egoCam/{self.time}.png', self.imDecode)
    ...
    def pointCloud_callback(self, msg: PointCloud2):
        ...
        # cloud.to_file(f"/ROS2_blue_bot/blue_bot/src/blue_bot_controller/resource/24_10_19_sensorDump/points/{self.posX}_{self.posY}_points.ply")
    ...
    def saveObs(self):
        ...
        if self.time > 20:
            ...
            df.to_csv(f'/ROS2_blue_bot/blue_bot/src/blue_bot_controller/resource/24_10_19_sensorDump/trajectory.csv', index=False)
            sys.exit(0)
