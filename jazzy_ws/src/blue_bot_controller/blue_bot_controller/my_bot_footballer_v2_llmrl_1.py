...
path = "/src/blue_bot_controller/blue_bot_controller"
os.chdir(path)

cwd = os.getcwd()
print(cwd)

# from blue_bot_v2.src.blue_bot_controller.blue_bot_controller.blue_bot_rl_v2.blue_bot_rl_v2.blue_bot_footballer_rl_v1 import blue_botEnv
# from blue_bot_rl_v2.blue_bot_footballer_rl_v1 import blue_botEnv
from blue_bot_controller.blue_bot_controller.blue_bot_rl_v2.torchrl_1 import blue_botEnv
baseEnv = blue_botEnv()
...
from blue_bot_controller.blue_bot_controller.blue_bot_rl_v2.vlm_florence2_1 import segment_image

###

class mybotFootballerV2Node(Node):
    def __init__(self) -> None:
        super().__init__("blue_bot_footballer_v2_llmrl")
    ...
    def image_callback(self, msg: CompressedImage):
        ...
        if picTime % 5 == 0:
            ...
            # cv.imwrite(f'/blue_bot/src/my_robot_controller/my_robot_controller/temp/LLMRun/{picTime}.png', self.imgSave)
